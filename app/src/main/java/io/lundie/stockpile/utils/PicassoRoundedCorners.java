...
public class PicassoRoundedCorners implements Transformation {
    ...
    public PicassoRoundedCorners(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public PicassoRoundedCorners(int radius, int margin, CornerType cornerType) {
        mRadius = radius;
        mDiameter = radius * 2;
        mMargin = margin;
